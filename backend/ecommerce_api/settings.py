...
SECRET_KEY = 'django-insecure-o!6+obn1s^0cz=2!dem^$4f*zf@njz%3jpc(fpb@=t8p3&ift('
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            ...
            'extra_params': 'Trusted_Connection=yes' if os.getenv('DB_TRUSTED_CONNECTION') == 'True' else '',
        },
    }
}
